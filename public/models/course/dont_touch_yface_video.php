            ...
            <div class="main-right">
                <div class="video-column">
                    ...
                    <div class="video-info">
                        <h1 class="video-title">App "Đừng Chạm Tay Lên Mặt"</h1>
                ...
                <div class="playlist-column">
                    <div class="curriculum-header">
                        ...
                        <div class="course-stats">
                            <span><strong>13</strong> bài học</span> • <span><strong>1h 34m</strong></span>
                        </div>
                    </div>
                    ...
                    <div class="curriculum-list scroll-bar">
                        <div class="accordion-item">
                            ...
                            <ul class="dropdown" style="display: block;">
                                ...
                                <li class="lesson-item active"
                                    onclick="changeVideo(this, 'r6GWbQL-qwA?si=G94zsTHlXy1GcNtG', ' Giới thiệu')">
                                ...
                                <li class="lesson-item"
                                    onclick="changeVideo(this, 'WIyfBMdtNTE?si=SizEmJd0cWbyS9tN', '2. Demo AI hoạt động')">
                                    <div class="lesson-info">
                        ...
                        <div class="accordion-item">
                            <div class="list_title" onclick="toggleDropdown(this)">
                                <div class="title-text">
                                    ...
                                    <span class="lesson-count">6/6 | 45:00</span>
                                </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <ul class="dropdown">
                                ...
                                <li class="lesson-item"
                                    onclick="changeVideo(this, 'xjXoFX3X2yg?si=K21KJb-y_XY8TMLb', '10. Training function')">
                                    <div class="lesson-info">
                                        <i class="fa-regular fa-circle-play status-icon"></i>
                                        <div class="lesson-text">
                                ...
                                <li class="lesson-item"
                                    onclick="changeVideo(this, 'C4jm3RWSw10?si=F0d-Wt_QFb1id3y2', '11. Running function')">
                                    <div class="lesson-info">
                                        <i class="fa-regular fa-circle-play status-icon"></i>
                                        <div class="lesson-text">
                                ...
                                <li class="lesson-item"
                                    onclick="changeVideo(this, 'pwWS_VcR9Ks?si=62sawkE1fKzrPEvK', '12. Implement audio and notification')">
                                    <div class="lesson-info">
                                        <i class="fa-regular fa-circle-play status-icon"></i>
                                        <div class="lesson-text">
                                ...
                                <li class="lesson-item"
                                    onclick="changeVideo(this, 'D5Xd9FByKXc?si=cp5R3sszcUgpjOcX', '13. Traning guide')">
                                    <div class="lesson-info">
                                        <i class="fa-regular fa-circle-play status-icon"></i>
                                        <div class="lesson-text">
                                            <span class="lesson-name">13. Traning guide</span>
