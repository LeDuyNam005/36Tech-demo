    ...
    <div class="container_content_inside_card">
        <div class="left_content_inside">
            <div class="course-header">
                <h1>Lập trình Python cho người mới bắt đầu</h1>
            ...
            <div class="what-you-learn-box">
                ...
                <div class="learn-grid">
                    <ul class="list_gt">
                        <li>Nắm vững cú pháp Python, cài đặt môi trường và làm việc với IDE.</li>
                        <li>Làm chủ các cấu trúc dữ liệu: List, Tuple, Set, Dictionary & String.</li>
                        <li>Tư duy logic với cấu trúc rẽ nhánh và vòng lặp (While, For).</li>
                    </ul>
                    <ul class="list_gt">
                        <li>Kỹ thuật viết hàm nâng cao: Lambda, Yield, Packing & Unpacking.</li>
                        <li>Thành thạo các thao tác nhập xuất dữ liệu và xử lý File.</li>
                        <li>Hiểu rõ về phạm vi biến (Global/Local) và Functional tools.</li>
                    </ul>
                </div>
            </div>
        ...
        <div class="right_content_wrapper">
            <div class="course-card">
                <div class="course-img-wrapper">
                    <img src="./models/img/python.jpg" alt="Khóa học Python">
                    <div class="play-overlay"><i class="fa-solid fa-play"></i></div>
                </div>

                <div class="card-body">
                    <div class="price-tag">Khoá học Python</div>
                    <a class="btn_buy" href="./models/course/python_video.php">Xem ngay</a>
