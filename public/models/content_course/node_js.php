        ...
        <div class="left_content_inside">
            ...
            <div class="curriculum-section">
                ...
                <div class="course-stats">
                    ...
                    <span>•</span>
                    <span><strong>12 giờ 05 phút</strong> thời lượng</span>
                </div>
                ...
                <div class="list_dropdown">
                    <div class="accordion-item">
                        ...
                        <ul class="dropdown">
                            <li>
                                <span><i class="fa-regular fa-circle-play"></i> 1. Lời khuyên trước khóa học</span>
                                <span class="time">10:41</span>
                            </li>
                            <li>
                                <span><i class="fa-regular fa-circle-play"></i> 2. HTTP protocol</span>
                                <span class="time">22:20</span>
                            </li>

                            <li>
                                <span><i class="fa-regular fa-circle-play"></i>3. SSR & CSR</span>
                                <span class="time">22:20</span>
                            </li>

                            <li>
                                <span><i class="fa-regular fa-circle-play"></i> 4. Install Node</span>
                                <span class="time">22:20</span>
                            </li>

                            <li>
                                <span><i class="fa-regular fa-circle-play"></i>5. Install ExpressJS</span>
                                <span class="time">22:20</span>
                            </li>

                            <li>
                                <span><i class="fa-regular fa-circle-play"></i>6. Install Nodemon & inspector</span>
                                <span class="time">22:20</span>
                            </li>

                            <li>
                                <span><i class="fa-regular fa-circle-play"></i>7. Add git repo </span>
                                <span class="time">22:20</span>
                            </li>

                            <li>
                                <span><i class="fa-regular fa-circle-play"></i> 8. Install Morgan</span>
                                <span class="time">22:20</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <ul class="dropdown">
                            <li>
                                <span><i class="fa-regular fa-circle-play"></i> 9. Template engine (handlebars)</span>
                    ...
                    <div class="accordion-item">
                        <div class="list_title" onclick="toggleDropdown(this)">
                            ...
                            <span class="lesson-count">20 bài học</span>
                        </div>
                        <ul class="dropdown">
                            <li>
                                <span><i class="fa-regular fa-circle-play"></i>17. Mô hình MVC</span>
                                <span class="time">08:37</span>
                            </li>
            ...
            <div class="course-card">
                ...
                <div class="card-body">
                    ...
                    <ul class="course-features">
                        ...
                        <li><i class="fa-solid fa-clock"></i> Thời lượng 12h 05p</li>
