        ...
        <div class="left_content_inside">
            ...
            <div class="what-you-learn-box">
                ...
                <div class="learn-grid">
                    <ul class="list_gt">
                        <li>Hiểu rõ bản chất Git, GitHub và quy trình quản lý mã nguồn.</li>
                        <li>Biết cách tạo Project và cấu hình kết nối bảo mật (SSH Key).</li>
                        <li>Thành thạo các câu lệnh Git thông dụng trong công việc thực tế.</li>
                    </ul>
                    <ul class="list_gt">
                        <li>Kỹ năng làm việc nhóm (Teamwork) và quy trình phối hợp trên GitHub.</li>
                        <li>Tư duy xử lý xung đột code (Resolve Conflict) hiệu quả.</li>
                        <li>Biết cách sao lưu (Backup), khôi phục dữ liệu và làm việc với GitLab.</li>
                    </ul>
                </div>
            </div>
        ...
        <div class="right_content_wrapper">
            <div class="course-card">
                <div class="course-img-wrapper">
                    <img src="./models/img/github.webp" alt="Khóa học GitHub">
                    <div class="play-overlay"><i class="fa-solid fa-play"></i></div>
                </div>

                <div class="card-body">
                    <div class="price-tag">Khoá học GitHub</div>
                    <a class="btn_buy" href="./models/course/github_video.php">Xem ngay</a>
